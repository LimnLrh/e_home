<template>
    <div class="xinwen wrapper" ref="wrapper">
        <mt-loadmore :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore" :autoFill="isAutoFill">
            <router-link :to="{path:'/xq/:id',query:{id:item.newsId}}" v-for="(item,index) in newsArr" v-bind:key="index">
    ...
    export default {
        ...
        methods:{
            ...
            loadFrist() {
                ...
                this.$axios
                .get(`/news/newsList.do?page=${this.page}&rows=10&type=${type}`)
                .then(res => {
                    this.page = 1;
